<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white shadow-md rounded-xl p-6 border border-gray-100">
            ...
            <p class="text-3xl font-bold mt-4 text-[#2E2E2E]">{{ $ofertasActivas }}</p>
        ...
        <div class="bg-white shadow-md rounded-xl p-6 border border-gray-100">
            ...
            <p class="text-3xl font-bold mt-4 text-[#2E2E2E]">{{ $candidatosInscritos }}</p>
        ...
        <div class="bg-white shadow-md rounded-xl p-6 border border-gray-100">
            ...
            <p class="text-3xl font-bold mt-4 text-[#2E2E2E]">{{ $empresasRegistradas }}</p>
